							...
							<form method="POST" class="my-login-validation" novalidate="">
								...
								<div class="form-group">
									<div class="custom-checkbox custom-control">
										...
										<label for="agree" class="custom-control-label">Estoy de acuerdo con los <a href="#">Terminos y Condiciones</a></label>
										<div class="invalid-feedback">
								...
								<div class="form-group m-0">
									<a href="login.php">
									<input type="button" value="Registrarse" class="btn btn-primary btn-block">
										
									</input>
									</a>
								</div>
								<div class="mt-4 text-center">
									¿Ya tenes una cuenta? <a href="login.php">Login</a>
								</div>
							</form>
						</div>
					</div>
